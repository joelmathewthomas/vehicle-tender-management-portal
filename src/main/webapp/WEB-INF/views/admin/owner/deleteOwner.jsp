...
<%@ page import="com.vtmp.home.admin.owner.details.OwnerDetails"%>
...
<body>
	<div id="root">
		...
		<div class="content">
			...
			%>
			<div id="form">
				<form action="${pageContext.request.contextPath}/admin/owner/delete"
					method="GET">
					<div class="heading">
						<p>Delete Owner</p>
					</div>
						...
						<div id="name" class="input">
							<div>
								...
								<input type="text" name="fname" placeholder="First Name"
									...
									pattern="[A-Za-z ]{2,30}" title="Only letters allowed." readonly />
							</div>
							<div>
								<input type="text" name="mname" placeholder="Middle Name"
									value="<%=(owner.getMname() == null || owner.getMname().isEmpty()) ? " " : owner.getMname()%>"
									pattern="[A-Za-z ]{0,30}" title="Only letters allowed." readonly />
							</div>
							<div>
						...
						<div id="additional" class="input">
							...
							<div>
								<input type="text" name="phone" placeholder="Phone Number"
									...
									maxlength="10" title="Enter a valid 10-digit phone number." readonly />
							</div>
							<div>
